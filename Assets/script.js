...
window.addEventListener("load", (event) => {
    instructionsContainer.innerHTML = "Welcome to the quiz on coding! Once you press start,you will have 75 seconds to complete this multiple choice quiz. If you get a question wrong, time will be deducted. You're final score will be the number of seconds left. Post your initials with your score at the end!";
    body.appendChild(instructionsContainer);
    instructionsContainer.appendChild(submitButton);
...
startButton.addEventListener("click", function (event) {
	if (event.target.matches("button")) {
        countDown();
        instructions.classList.remove("unseen");
